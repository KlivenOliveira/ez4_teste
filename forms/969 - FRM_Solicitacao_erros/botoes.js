...
function anexo(event) {
    try {
        ...
        if (acao == "upload") {
            ...
            console.log('to passando aqui :' + fileDescription)
            console.log('to aqui:' + inputFile)
        }
...
function uploadFile(fileDescription, idInput) {
    try {
        ...
        if (!getMobile()) {
            ...
            console.log('fileDescripition:' + fileDescription)
            console.log('Idinput:' + idInput)
        }
    } catch (e) {
...
function downloadFile(fileDescription, idInput) {
    try {
        const filename = getMode() == "ADD" ? $(`#${idInput}`).text() : $(`#${idInput}`).val()
...
function setFilePhisicalName(idInput, filePhisical) {
    try {
        if (idInput.indexOf("_") == 0) {
            ...
            console.log('tratamento ' + filePhisical)
        }
        $("#" + idInput).val(filePhisical);
        console.log('idinput:' + idInput)
        console.log('filePshisical' + filePhisical)
    } catch (e) {
